const CONFIG = {
nama: "Vino Store", // Nama Store
profil: "https://files.catbox.moe/9lr583.png", // Url Profil
banner: "https://files.catbox.moe/9gr5z6.jpeg", // Url Banner 
tentang: "Vino Store adalah toko online terpercaya yang telah melayani ribuan pelanggan sejak 2020. Kami menyediakan berbagai produk digital untuk kebutuhan sehari-hari dengan kualitas terbaik dan harga terjangkau.\n\nKomitmen kami adalah memberikan pengalaman berbelanja yang menyenangkan dengan pelayanan terbaik, produk original, dan garansi resmi untuk semua produk yang kami jual.",
alamat: "Jl. Kalimantan Jakarta, Indonesia",
sosial_media: {
  email: "vinoprianda@gmail.com", // Email
  youtube: "Vinoprianda", // YouTube Username 
  tiktok: "zass.id", // Tiktok Username 
  whatsapp: "6289503365273", // WhatsApp Number 
  telegram: "Vino XfoXF" // Telegram Username
},
payment: {
  dana: "089503365273", // Payment Dana
  gopay: "Tidak Tersedia", // Payment Gopay 
  ovo: "Tidak Tersedia", // Payment Ovo 
  qris: "Chat Admin" // Url Qris
},
telegram_api: {
  bot: "62828278:7678blablabla", // Token bot father
  chatid: "8979034619" // ID telegram
},
}
...
const productsData = {
            "Hosting": [
              {
                ...
                "variants": [
                  ...
                  { "name": "Unlimited RAM", "price": 11000 }
                ]
              },
              {
                "id": 2,
            ...
            "Produk Digital": [
                ...
                },
                {
                    ...
                    variants: [
                        { name: "Alight Motion Premium (1 Tahun)", price: 35000 },
